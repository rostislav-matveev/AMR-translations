...
\bigskip
\centerline{\begin{lpic}{h-triangle(0.3)}
  \end{lpic}
}
...
\bigskip
\begin{lpic}[draft,l(10mm),r(10mm),b(10mm),clean]{cayley(0.2)}
  \lbl[rb]{0,90;$X$}
  \lbl[rb]{180,160;$Y$}
  \lbl[rb]{47,112;$A$}
  \lbl[rb]{107,138;$B$}
...
\end{lpic}
\begin{lpic}[draft,clean,l(10mm),r(10mm),b(10mm)]{cayley-lines(0.2)}
  \lbl[rb]{57,25;$D$}
  \lbl[rb]{107,138;$P$}
...
This simply means that $x$ and $y$ are connected by a segment of the
correct length. Thus, whenever we have three points $x,y,z$, we can
...
\centerline{
  \begin{lpic}[draft,t(0mm),l(5mm),r(5mm),b(5mm),clean]{h-triangle(0.3)}
  \lbl[]{2.5,12;$\bullet$}
  \lbl[]{127,2;$\bullet$}
  \lbl[]{112,111;$\bullet$}
  \lbl[]{82,57;$\bullet$}
...
$0$-hyperbolic) spaces, called \textit{trees}.

The left figure below shows a \textit{tree}.

\centerline{
  \begin{lpic}[l(10mm),r(10mm),b(10mm),t(2mm)]{tree(0.3)}
    \lbl[t]{50,-10; A tree.}
  \end{lpic}
  \begin{lpic}[l(10mm),r(10mm),b(10mm),t(2mm)]{not-tree(0.3)}  
    \lbl[t]{50,-10; Not a tree.}
  \end{lpic}}

It contains a certain number of vertices, some of which are connected
by edges. The term \textit{tree} is reserved for such a network provided it has
no closed loops.
...
\centerline{
\begin{lpic}[draft,t(5mm),l(5mm),r(5mm),b(5mm),clean]{t-triangle(0.3)}
  \lbl[t]{-5,10;$x$}
  \lbl[lt]{130,0;$y$}
  \lbl[bl]{115,115;$z$}
  \lbl[tl]{71,69;$c$}
...
\begin{quote}\sf
  ...
  \centerline{
    \begin{lpic}[b(12mm)]{gauss-triangles(0.5)}
  ...
  \centerline{
    \begin{lpic}{gauss-t-triangle(0.5)}
    \end{lpic}
  }
